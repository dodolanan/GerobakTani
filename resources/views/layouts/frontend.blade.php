...
<html lang="zxx">
  <head>
    ...
    <title>Gerobakpetani | Template</title>
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> Gerobakpetani@gmail.com</li>
          <li>Gratis Pengiriman Wilayah Kota Jepara</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Alamat: Jepara</li>
                <li>Phone: 0811111111</li>
                <li>Email: Gerobaksayur@gmail.com</li>
              </ul>
            </div>
          </div>
